...
| 패키지 | 버전 | 역할 |
|---|---|---|
| `cachy-omarchy-shell` | 4.0.0-20 | 핀된 Omarchy Quattro 셸 런타임 (Quickshell 트리, `omarchy-settings` 제외) |
| `cachy-omarchy-overlay` | 0.12.1-1 | CachyOS 통합 계층 (래퍼 명령, Hyprland 바인딩, 기본값) |
